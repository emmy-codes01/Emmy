...
/* ---------------------------------------------------------
   ...
   Grotesk for display, amber/violet accent, flat dark ground.
   No per-image tags or captions — the work speaks for itself.
   --------------------------------------------------------- */
...
const META = [
  { l: 'Client', v: 'RCR Racing' },
  { l: 'Industry', v: 'Motorsport · Rebrand' },
  { l: 'Scope', v: 'Identity, Merch, Applications' },
]
      ...
      <div className="max-w-[1100px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <header className="reveal pt-14 lg:pt-20 pb-10">
          ...
          <h1 className="text-[2.4rem] md:text-[4rem] leading-[1.05] mt-4" style={display}>
            RCR <span style={{ color: ACCENT }}>Racing</span>
          </h1>
          <p className="text-white/40 text-xs mt-3 tracking-[0.14em] uppercase">Sports · Car Racing · Rebrand</p>

          <p className={`${body} max-w-xl mt-7`}>
            A full rebrand for RCR Racing — logo across surfaces, merchandise, and broadcast
            applications, built to hold up on a track, a jacket, or a screen.
          </p>
